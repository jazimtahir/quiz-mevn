...
<template>
    <div class="flex flex-row">
        ...
        <div class="w-full px-4 bg-gray-800 p-4">
            ...
            <div class="mt-4">
                <div v-for="(option, key) in mcq.options" class="w-full border border-gray-500 text-gray-300 rounded m-1" :id="`mcq-${ mcq._id }-${ key }`" >
